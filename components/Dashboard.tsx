...
import { NewBadgeUnlockedModal } from './NewBadgeUnlockedModal';
import { LevelUpModal } from './LevelUpModal';
import { LogCompetitionModal } from './LogCompetitionModal';
...
export const MainLayout = (props: MainLayoutProps) => {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case 'learningHub':
// FIX: Pass the required user and onNavigate props to the LearningHubPage component.
      ...
      case 'mentorship':
        ...
        return <MentorshipPage mentors={mentors} peers={peers} onSendMessage={onSendMessage} currentUser={user} />;
      default:
